...
namespace CarpinteriaGUI.Datos.implementacion
{
    internal class PresupuestoDao : IPresupuestoDao
    {
        ...
        public List<Presupuesto> ObtenerPresupuestoPorFiltros(DateTime desde, DateTime hasta, string cliente)
        {
        ...
        public Presupuesto ObtenerPresupuestoNro(int numero)
        {
            ...
            foreach (DataRow fila in tabla.Rows)
            {
                ...
                DetallesPresupuesto dp = new DetallesPresupuesto(pro, cant);
